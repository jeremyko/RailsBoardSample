Ruby on Rails sample message board - More Rails way !!

- RESRful
- View manipulation with partial
- bootstrap 적용
...
D:\kojh_data\Dev\Ruby_Dev\RailsBoard>rake routes
...
listSearchedSpecificPageWork        /listSearchedSpecificPageWork(.:format) my_rails_board_rows#listSearchedSpecificPageWork
